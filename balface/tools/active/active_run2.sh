...
NUM_STAGE=$2
SAMPLE_NUM=$3
CKPT_FILE='./work_dirs/race_cls_fairface_4race025-7000-white-5380-540-balanced_resnet34_adam/epoch_70.pth'
...
#  then
  ...
  bash tools/dist_train2.sh configs/active/${ORIG_POOL_ROOT}/${POOL_ROOT}.py 8
#  fi

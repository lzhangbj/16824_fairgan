...
data = dict(
    labeled_train=dict(
        ...
        n_classes=[4,],
        size=224,
        face_label_txt="./datasets/FairFace/labels/cond-aug/fairface_imb_14k-40k_combined_craig_selected-appended_14k.txt",
        samples_per_gpu=256,
        workers_per_gpu=4,
        mode='train'
    ),
    unlabeled_train=dict(
        ...
        root="./datasets/FairFace/025_images",
        size=224,
	    face_label_txt="./datasets/FairFace/labels/cond-aug/fairface_imb_14k-40k_combined_craig_selected-appended_14k_unlabeled.txt",
	    samples_per_gpu=256,
        workers_per_gpu=4,
        mode='train'
    ),
...
resume_from = None #'work_dirs/fixmatch_fairface-craig-appended-14k_resnet34_adam/latest.pth'
load_backbone = None
load_from = None

...
data = dict(
    ...
    unlabeled_train=dict(
        ...
        root="./datasets/FairFace/025_images",
        size=224,
	    face_label_txt="./datasets/FairFace/labels/cond-aug/fairface_14k-400k_craig_15k_appended_unlabeled.txt",
	    samples_per_gpu=488,
        workers_per_gpu=8,
        mode='train'
    ),
...
resume_from = 'work_dirs/fixmatch_fairface-craig-appended-400k-15k_resnet34_adam/epoch_10.pth'
load_backbone = None
load_from = None

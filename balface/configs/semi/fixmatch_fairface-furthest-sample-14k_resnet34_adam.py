...
data = dict(
    labeled_train=dict(
        ...
        n_classes=[4,],
        size=224,
        face_label_txt="./datasets/FairFace/labels/cond-aug/furthest_sample_14k.txt",
        samples_per_gpu=18,
        workers_per_gpu=2,
        mode='train'
    ),
    unlabeled_train=dict(
        ...
        root="./datasets/FairFace/025_images",
        size=224,
	    face_label_txt="./datasets/FairFace/labels/cond-aug/furthest_sample_14k_unlabeled.txt",
	    samples_per_gpu=494,
        workers_per_gpu=8,
        mode='train'
    ),

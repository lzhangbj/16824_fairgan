...
data = dict(
    train=dict(
        dataset="cls_fairface_age_025_aug",
        root="./datasets/FairFace/025_images",
        n_classes=[9,],
        face_label_txt="./datasets/FairFace/labels/age/fairface_train_age-18636-20s-5679-balanced_label.txt",
		aug_face_label_txt="./datasets/FairFace/labels/cond-aug-age/fairface_age_imb_18k_aug_180k.txt",
        size=224,
	    weights_list=[0.1, ],
        samples_per_gpu=512,
        workers_per_gpu=8,
	...
	val=dict(
		dataset="cls_fairface_age_025",
		root="./datasets/FairFace/025_images",
		size=224,
		n_classes=[9, ],
		face_label_txt="./datasets/FairFace/labels/age/fairface_age_val_balanced_label.txt",
		samples_per_gpu=256,
		workers_per_gpu=8,
		mode='val'
	),

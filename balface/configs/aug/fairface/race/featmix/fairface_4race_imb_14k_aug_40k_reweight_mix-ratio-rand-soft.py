...
data = dict(
    train=dict(
		...
		aug_face_label_txt="./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k.txt",
        size=224,
	    weights_list=[0.1, ],
        samples_per_gpu=512,
        workers_per_gpu=8,
...
load_from = 'work_dirs/race_cls_fairface_imb_14k_reweight_resnet34_adam/best_model.pth'
...
data = dict(
    train=dict(
		...
		aug_face_label_txt="./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_eval_labels.txt",
        size=224,
	    weights_list=[1., ],
        samples_per_gpu=256,
        workers_per_gpu=8,
...
trainer = dict(
    ...
    val_freq=5,
    loss_weight='none',
    sample_ratio=[24125., 10487, 10378, 9010]
)
...
resume_from = None # 'work_dirs/fairface_4race_imb_14k_aug_40k_eval-label/.pth'
load_backbone = None  # 'work_dirs/ssp_fakemake-100000_resnet34_adam/epoch_40.pth'
load_from = None #'work_dirs/fairface_4race_imb_14k_aug_40k_eval-label/epoch_50.pth'
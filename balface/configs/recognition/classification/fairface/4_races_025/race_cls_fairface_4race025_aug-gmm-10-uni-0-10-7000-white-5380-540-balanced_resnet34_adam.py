...
data = dict(
    train=dict(
		...
		aug_face_label_txt="./datasets/FairFace/labels/aug/gen_7k-white226-2258_gmm-10_uni-0-10_label.txt",
        size=224,
        samples_per_gpu=256,
        workers_per_gpu=8,
        mode='train'
...
resume_from ='work_dirs/race_cls_fairface_4race025_aug-gmm-10-uni-0-10-7000-white-5380-540-balanced_resnet34_adam/epoch_50.pth'

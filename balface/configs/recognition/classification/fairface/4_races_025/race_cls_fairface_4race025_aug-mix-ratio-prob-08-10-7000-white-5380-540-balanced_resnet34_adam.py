...
data = dict(
    train=dict(
        dataset="cls_fairface_4races_025_ratioaug",
		...
		aug_face_label_txt="./datasets/FairFace/labels/aug/gen_7k-white226-2258_mix_ratio-prob-alpha-08-10_label.txt",
        size=224,
        samples_per_gpu=256,
        workers_per_gpu=8,
        mode='train'
...
resume_from = None #'work_dirs/race_cls_fairface_4race025_aug-gmm-10-uni-0-10-7000-white-5380-540-balanced_resnet34_adam/epoch_50.pth'

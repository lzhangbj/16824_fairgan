...
data = dict(
    train=dict(
        ...
        face_label_txt="./datasets/FairFace/labels/race/fairface_train_race-800-white-500-50_label.txt",
        size=224,
        samples_per_gpu=256,
        workers_per_gpu=8,
    ),
...
resume_from = None
load_backbone = 'work_dirs/ssp_fakemake-100000_resnet34_adam/epoch_50.pth'
...
data = dict(
    ...
    unlabeled_train=dict(
        dataset="fixmatch",
        root="./datasets/CelebAMask/images",
        size=224,
        face_bbox_txt="./datasets/CelebAMask/bbox/celebamask-30000_bbox.txt",
        samples_per_gpu=128,
        workers_per_gpu=4,
        mode='train'
    ),
...
resume_from = None # 'work_dirs/race_fixmatch_adapt-ratio_fairface-race-8000-white-5000_fakemake-100000_resnet34_adam/epoch_26.pth'
load_backbone = 'work_dirs/race_cls_fairface_all_resnet34_adam/epoch_40.pth'
load_model = None
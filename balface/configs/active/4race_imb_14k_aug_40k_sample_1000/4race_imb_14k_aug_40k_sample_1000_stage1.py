...
data = dict(
    train=dict(
		...
		aug_face_label_txt="./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage1.txt",
        size=224,
	    weights_list=[0.1,],
        samples_per_gpu=512,
        workers_per_gpu=8,
...
load_from = 'work_dirs/race_cls_fairface_4race025-14000-white-10760-1080-balanced_resnet34_adam/epoch_50.pth'
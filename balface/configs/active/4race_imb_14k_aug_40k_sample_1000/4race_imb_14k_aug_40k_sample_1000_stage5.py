...
data = dict(
    train=dict(
		...
		aug_face_label_txt_list=[
			"./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage1.txt",
			"./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage2.txt",
			"./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage3.txt",
			"./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage4.txt",
			"./datasets/FairFace/labels/cond-aug/4race_imb_14k_aug_40k_sample_1000_stage5.txt",
			],
        size=224,
...
load_from = 'work_dirs/4race_imb_14k_aug_40k_sample_1000_stage4/best_model.pth'
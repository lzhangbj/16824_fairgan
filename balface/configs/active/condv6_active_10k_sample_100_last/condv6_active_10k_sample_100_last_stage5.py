...
data = dict(
    train=dict(
		...
		aug_face_label_txt_list=[
			"./datasets/FairFace/labels/cond-aug/condv6_active_10k_sample_100_last_stage1.txt",
			"./datasets/FairFace/labels/cond-aug/condv6_active_10k_sample_100_last_stage2.txt",
			"./datasets/FairFace/labels/cond-aug/condv6_active_10k_sample_100_last_stage3.txt",
			"./datasets/FairFace/labels/cond-aug/condv6_active_10k_sample_100_last_stage4.txt",
			"./datasets/FairFace/labels/cond-aug/condv6_active_10k_sample_100_last_stage5.txt"
			],
        size=224,
...
load_from = 'work_dirs/condv6_active_10k_sample_100_last_stage4/epoch_20.pth'
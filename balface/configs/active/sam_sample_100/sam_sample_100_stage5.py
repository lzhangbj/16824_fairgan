...
data = dict(
    train=dict(
		...
		aug_face_label_txt_list=[
				"./datasets/FairFace/labels/cond-aug/sam_sample_100_stage1.txt",
				"./datasets/FairFace/labels/cond-aug/sam_sample_100_stage2.txt",
				"./datasets/FairFace/labels/cond-aug/sam_sample_100_stage3.txt",
				"./datasets/FairFace/labels/cond-aug/sam_sample_100_stage4.txt",
				"./datasets/FairFace/labels/cond-aug/sam_sample_100_stage5.txt",
			],
        size=224,
...
load_from = 'work_dirs/sam_sample_100_stage4/best_model.pth'